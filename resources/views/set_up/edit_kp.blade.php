...
<div class="row">
    <form action="/batas_kp/update/{{$data_kp->id_kp}}" method="POST" class="form-horizontal">
    {{csrf_field()}}
        <div class="form-group">
            <div class="box box-default color-palette-box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-tag"></i> Pengaturan Pelaksanaan Batas KP</h3>
                    </div>
                        <div class="box-body">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="dosen_id" name="dosen_id" value="{{ $data_kp->dosen_id }}" readonly >
                                </div>
                            </div> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="judul" name="judul" value="{{ $data_kp->judul }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Lembaga</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="lembaga" name="lembaga" value="{{ $data_kp->lembaga }}" readonly>
                                </div>
                            </div>
