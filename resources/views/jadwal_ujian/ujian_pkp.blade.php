...
<div class="box box-primary">
        ...
        <h3 class="box-title">Penjadwalan Ujian Pra Kp</h3>
        ...
        <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="/ujian_kp">Jadwal Kp</a></li>
                    <li><a href="/ujian_pkp">Jadwal Pra Kp</a></li>
                  </ul>
        </div>
        </div>
                  ...
                  <tr>
                      ...
                      <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/ujian_pkp/edit/{{$key->id_pkp}}">Edit</a></li>
